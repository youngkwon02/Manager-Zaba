        ...
        <div class="calendarBody">            
            ...
            <?php
                ...
                if($_SESSION['filter'] === 'my'){
                    ...
                    echo("<script>console.log(".count($date_arr).")</script>");
